/* OBS: Dos Commits 1 até o 11 todo o aprendizado foi centrado no curso da Alura:  Formação Aprenda a programar em Java com Orientação a Objetos. A partir do commit 12, ele está centrado no curso: Java trabalhando com lista e coleções de dados. */
...
No primeiro (1°) commit foi a criação do projeto em si, criação da classe "Main" e "Filmes", criação de métodos e atributos;
...
Décimo segundo (12°) commit, início no aprendizado sobre lists,ArrayLists e criação da lista "listaDeFilmes". Estamos herdando o método "toString()" da classe mãe de todas as classes "Object" e modificamos para que quando chamássemos a "listaDeFilmes", ela fosse apresentada da seguinte forma: "Filme: Avatar(2023)"; 
